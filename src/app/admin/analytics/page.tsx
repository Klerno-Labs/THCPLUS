...
export default async function AdminAnalyticsPage() {
  try {
    ...
    let submissionsByDay: { date: Date; count: number }[] = []
    try {
      submissionsByDay = await prisma.$queryRaw<{ date: Date; count: number }[]>`
        SELECT
      ...
      console.error('Error fetching submissions by day:', error)
      ...
      <div className="p-6">
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">
            There was an error loading the analytics data. This could be due to a database
            connection issue.
          </p>
