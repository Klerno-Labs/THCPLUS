...
export const products: Product[] = [
  // Vapes
  {
    ...
    category: 'vapes',
    price: 29.99,
    image: '/images/products/vape-delta8.jpg',
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    category: 'vapes',
    price: 39.99,
    image: '/images/products/vape-thca.jpg',
    inStock: true,
    featured: true,
    cannabinoids: ['THCA'],
    thcContent: '90% THCA',
  ...
  },
  {
    ...
    category: 'vapes',
    price: 34.99,
    image: '/images/products/vape-hhc.jpg',
    inStock: true,
    cannabinoids: ['HHC'],
    thcContent: '92% HHC',
    labTested: true,
  ...
  // Edibles
  {
    ...
    category: 'edibles',
    price: 24.99,
    image: '/images/products/gummies-delta9.jpg',
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    category: 'edibles',
    price: 19.99,
    image: '/images/products/gummies-cbd-sleep.jpg',
    inStock: true,
  ...
  },
  {
    ...
    category: 'edibles',
    price: 39.99,
    image: '/images/products/gummies-thcp.jpg',
    inStock: false,
    cannabinoids: ['THCP'],
  ...
  // Flower
  {
    ...
    category: 'flower',
    price: 49.99,
    image: '/images/products/flower-purple-haze.jpg',
    inStock: true,
    featured: true,
    cannabinoids: ['THCA'],
    thcContent: '28% THCA',
  ...
  },
  {
    ...
    category: 'flower',
    price: 29.99,
    image: '/images/products/flower-cbd.jpg',
    inStock: true,
    cannabinoids: ['CBD'],
    cbdContent: '18% CBD',
  ...
  },
  {
    ...
    category: 'flower',
    price: 44.99,
    image: '/images/products/flower-indica.jpg',
    inStock: true,
    cannabinoids: ['THCA'],
    thcContent: '25% THCA',
    labTested: true,
  ...
  // Concentrates
  {
    ...
    price: 34.99,
    image: '/images/products/wax-delta8.jpg',
    inStock: true,
    cannabinoids: ['Delta-8'],
  ...
  },
  {
    ...
    category: 'concentrates',
    price: 44.99,
    image: '/images/products/live-resin.jpg',
    inStock: true,
    featured: true,
    cannabinoids: ['THCA'],
    thcContent: '88% THCA',
  ...
  },
  {
    ...
    category: 'pre-rolls',
    price: 24.99,
    image: '/images/products/prerolls-cbd.jpg',
    inStock: true,
    cannabinoids: ['CBD'],
    cbdContent: '16% CBD',
    labTested: true,
  ...
  // Tinctures
  {
    ...
    category: 'tinctures',
    price: 49.99,
    image: '/images/products/tincture-cbd.jpg',
    inStock: true,
    cannabinoids: ['CBD'],
  ...
  },
  {
    ...
    category: 'tinctures',
    price: 39.99,
    image: '/images/products/tincture-delta8.jpg',
    inStock: true,
    cannabinoids: ['Delta-8'],
  ...
  },
  {
    ...
    category: 'accessories',
    price: 24.99,
    image: '/images/products/storage-jars.jpg',
    inStock: true,
