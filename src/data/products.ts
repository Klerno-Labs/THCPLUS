...
export const products: Product[] = [
  // FLOWER
  {
    ...
    category: 'flower',
    price: 45.0,
    image: '/images/products/whiteboy-cookies.jpg',
    inStock: true,
    featured: true,
    cannabinoids: ['THCA'],
    thcContent: '28% THCA',
  ...
  },
  {
    ...
    category: 'flower',
    price: 45.0,
    image: '/images/products/lemon-zkittlez.jpg',
    inStock: true,
    featured: true,
    cannabinoids: ['THCA'],
    thcContent: '26% THCA',
  ...
  },
  {
    ...
    category: 'concentrates',
    price: 42.0,
    image: '/images/products/cookies-n-creme.jpg',
    inStock: true,
    cannabinoids: ['THCA'],
    thcContent: '86% THCA',
    labTested: true,
  ...
  },
  {
    ...
    category: 'concentrates',
    price: 40.0,
    image: '/images/products/sour-tangie.jpg',
    inStock: true,
    cannabinoids: ['THCA'],
    thcContent: '84% THCA',
    labTested: true,
